 ...
 */
contract Raffle is RaffleEvent, VRFConsumerBaseV2Plus {
    enum RaffleState {
        OPEN,
        CALCULATING
    }
     ...
     * 4. There are players in the lottery
     * 5. Implicitly, your subscription has LINK
     * param checkData not used
     * @return upkeepNeeded boolean indicating if it's time to restart the lottery
    ...
    function performUpkeep(bytes calldata /* performData */ ) external {
        ...
        // The emit is redundant since the VRF Coordinator emits the same data in an event
